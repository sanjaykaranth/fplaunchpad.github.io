...
The fellowship sits at the centre of everything FP Launchpad does. Fellows work full-time on ambitious projects in systems and functional programming: building real systems, publishing at top venues, and contributing to open-source software that people depend on. The [OCaml](https://ocaml.org/) programming language and the [OxCaml](https://oxcaml.org/) extensions are the primary research vehicles, but the problems cut across programming languages, compilers, runtime systems, formal verification, concurrency, security, and AI-augmented software engineering. For more on what is expected, see the [FP Launchpad charter](/charter/).
...
We want people who want to solve real problems. Not toy benchmarks, but problems like: building a [verifiable voting system](https://shakti.org.in/) on RISC-V hardware and [MirageOS](https://mirage.io/) unikernels, creating programmable public infrastructure for environmental planning, or writing a formally verified runtime system for a production language. These are [illustrative projects](/charter/) from our charter, the kind of work fellows will shape and drive. The projects use OCaml and OxCaml as their foundation.
...
If you are interested but feel you are not quite ready, that is fine. Start with the [systems foundations](https://kcsrk.info/ocaml/2025/11/10/hacking/) to hack on the OCaml compiler and the ecosystem, and apply when you are. This is the first cohort, and there will be future ones.
...
**MS/PhD at IIT Madras.** Fellows can earn course credits during the fellowship. If eligible, you can transition into a degree programme at IIT Madras, continuing your research momentum while earning a graduate degree. See [Pathways to IIT Madras](https://cystar.iitm.ac.in/join-us/#:~:text=Pathways%20to%20IIT%20Madras) for an overview of how this works.
...
**Found a company.** The technology you build here could be the seed. IIT Madras has one of India's strongest startup ecosystems, with an [incubation cell](https://www.iitm.ac.in/research-park/incubation-cell) and [research park](https://www.iitmrp.com/) designed to turn research into companies. If you want to turn research into a product, this is a good place to start.
...
<p style="text-align: center; margin: 2em 0;">
  <a href="https://docs.google.com/forms/d/e/1FAIpQLSdhS9b4vX1u7T1pAFhXc4ZADJXtVIFkHgUvjZOW1K9q9L9I9g/viewform" style="background-color: #005f73; color: white; padding: 12px 32px; text-decoration: none; border-radius: 4px; font-weight: bold;">Apply Now</a>
</p>
